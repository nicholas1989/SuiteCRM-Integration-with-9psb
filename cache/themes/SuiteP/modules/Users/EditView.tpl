...
<script type="text/javascript" src='include/SugarFields/Fields/Image/SugarFieldFile.js?v=00sZYa0mK_OQS0WvgEKieg'></script>
...
{$fields.employee_status.value}</span>{else}{$EMPLOYEE_STATUS_READONLY}{/if}
</div>
