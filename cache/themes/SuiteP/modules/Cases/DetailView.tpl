...
{if !$fields.service_chanel_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.service_chanel_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.service_chanel_c.name}" value="{ $fields.service_chanel_c.options }">
{ $fields.service_chanel_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.service_chanel_c.name}" value="{ $fields.service_chanel_c.value }">
{ $fields.service_chanel_c.options[$fields.service_chanel_c.value]}
{/if}
{/if}
...
{if !$fields.escalate_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.escalate_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.escalate_c.name}" value="{ $fields.escalate_c.options }">
{ $fields.escalate_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.escalate_c.name}" value="{ $fields.escalate_c.value }">
{ $fields.escalate_c.options[$fields.escalate_c.value]}
{/if}
{/if}
...
{if !$fields.service_interest_c.hidden}
{counter name="panelFieldCount" print=false}
...
{if !$fields.subcategory_c.hidden}
{counter name="panelFieldCount" print=false}
...
{if !$fields.service_persona_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.service_persona_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.service_persona_c.name}" value="{ $fields.service_persona_c.options }">
{ $fields.service_persona_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.service_persona_c.name}" value="{ $fields.service_persona_c.value }">
{ $fields.service_persona_c.options[$fields.service_persona_c.value]}
{/if}
{/if}
...
{if !$fields.agent_outlet_c.hidden}
{counter name="panelFieldCount" print=false}
...
<span id="contact_id_c" class="sugar_field" data-id-value="{$fields.contact_id_c.value}">{$fields.agent_outlet_c.value}</span>
...
{if !$fields.amount_disput_c.hidden}
{counter name="panelFieldCount" print=false}
...
{if !$fields.choose_file_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.choose_file_c.name}">{$fields.choose_file_c.value}</span>
{/if}
...
{if !$fields.update_info_c.hidden}
{counter name="panelFieldCount" print=false}

<span class="sugar_field" id="{$fields.update_info_c.name|escape:'html'|url2html|nl2br}">{$fields.update_info_c.value|escape:'html'|escape:'html_entity_decode'|url2html|nl2br}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_EMAIL_SOURCE' module='Cases'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.email_source_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.email_source_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.email_source_c.name}" value="{ $fields.email_source_c.options }">
{ $fields.email_source_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.email_source_c.name}" value="{ $fields.email_source_c.value }">
{ $fields.email_source_c.options[$fields.email_source_c.value]}
{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_SOURCE_EMAIL' module='Cases'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.source_email_c.hidden}
{counter name="panelFieldCount" print=false}

{if strlen($fields.source_email_c.value) <= 0}
{assign var="value" value=$fields.source_email_c.default_value }
{else}
{assign var="value" value=$fields.source_email_c.value }
{/if} 
<span class="sugar_field" id="{$fields.source_email_c.name}">{$fields.source_email_c.value}</span>
{/if}
