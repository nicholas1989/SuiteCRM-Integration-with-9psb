...
<input type='text' name='{$fields.name_advanced.name}'
    ...
    maxlength='150'        value='{$value}' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='website_advanced'>{sugar_translate label='LBL_WEBSITE' module='Accounts'}</label>
                            </div>
            <div class="form-item">
	...
	<input type='text' name='{$fields.website_advanced.name}' id='{$fields.website_advanced.name}' size='30' 
	   maxlength='255' value='{$fields.website_advanced.value}' title='' tabindex='0'  >
	{else}
	<input type='text' name='{$fields.website_advanced.name}' id='{$fields.website_advanced.name}' size='30' 
...
<input type='text' name='{$fields.address_street_advanced.name}'
    id='{$fields.address_street_advanced.name}' size='30'
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_city_advanced'>{sugar_translate label='LBL_CITY' module='Accounts'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.address_city_advanced.name}'
    id='{$fields.address_city_advanced.name}' size='30'
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_state_advanced'>{sugar_translate label='LBL_STATE' module='Accounts'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.address_state_advanced.name}'
    id='{$fields.address_state_advanced.name}' size='30'
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_postalcode_advanced'>{sugar_translate label='LBL_POSTAL_CODE' module='Accounts'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.address_postalcode_advanced.name}'
    id='{$fields.address_postalcode_advanced.name}' size='30'
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='billing_address_country_advanced'>{sugar_translate label='LBL_COUNTRY' module='Accounts'}</label>
                            </div>
            <div class="form-item">
