...
<select name="{$fields.account_types_c.name}"
id="{$fields.account_types_c.name}"
title=''              
>
{if isset($fields.account_types_c.value) && $fields.account_types_c.value != ''}
{html_options options=$fields.account_types_c.options selected=$fields.account_types_c.value}
{else}
{html_options options=$fields.account_types_c.options selected=$fields.account_types_c.default}
{/if}
</select>
</div>
...
<select name="{$fields.lga_c.name}"
id="{$fields.lga_c.name}"
title=''           
>
{if isset($fields.lga_c.value) && $fields.lga_c.value != ''}
{html_options options=$fields.lga_c.options selected=$fields.lga_c.value}
{else}
{html_options options=$fields.lga_c.options selected=$fields.lga_c.default}
{/if}
</select>
<script type="text/javascript">
    if(typeof de_entries == 'undefined'){literal}{var de_entries = new Array;}{/literal}
    var el = document.getElementById("state_c");
    addLoadEvent(function(){literal}{loadDynamicEnum({/literal}"state_c","{$fields.lga_c.name}"{literal})}{/literal});
    if (SUGAR.ajaxUI && SUGAR.ajaxUI.hist_loaded) {literal}{loadDynamicEnum({/literal}"state_c","{$fields.lga_c.name}"{literal})}{/literal}
</script>
</div>
...
addToValidate('EditView', 'lga_c', 'dynamicenum', false,'{/literal}{sugar_translate label='LBL_LGA' module='Accounts' for_js=true}{literal}' );
...
addToValidate('EditView', 'account_types_c', 'enum', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_TYPES' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'contact_type_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CONTACT_TYPE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'state_c', 'enum', false,'{/literal}{sugar_translate label='LBL_STATE' module='Accounts' for_js=true}{literal}' );
...
addToValidate('EditView', 'account_number_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_NUMBER' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'gender_c', 'enum', false,'{/literal}{sugar_translate label='LBL_GENDER' module='Accounts' for_js=true}{literal}' );
