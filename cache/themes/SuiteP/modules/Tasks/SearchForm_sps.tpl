...
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_date_modified_basic }' title=''  tabindex='' size="11" class="dateRangeInput">
