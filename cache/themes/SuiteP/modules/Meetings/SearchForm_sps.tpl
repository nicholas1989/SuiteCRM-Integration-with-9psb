...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='collection_basic' >{sugar_translate label='LBL_COLLECTION_TYPE' module='Meetings'}</label>
    	</td>
...
value="1" title='' tabindex="" {$checked} >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='date_modified_basic'> {sugar_translate label='LBL_DATE_MODIFIED' module='Meetings'}
		</td>
