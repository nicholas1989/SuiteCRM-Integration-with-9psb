<?php 
 $GLOBALS["dictionary"]["Case"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Amount In Dispute',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'amount_disput_c',
      'vname' => 'LBL_AMOUNT_DISPUT',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Casesamount_disput_c',
      'custom_module' => 'Cases',
    ),
    'update_info_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Update Information',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'update_info_c',
      'vname' => 'LBL_UPDATE_INFO',
      'type' => 'text',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Second Upload',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'sec_upload_c',
      'vname' => 'LBL_SEC_UPLOAD',
      'type' => 'image',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'width' => '120',
      'height' => '',
      'id' => 'Casessec_upload_c',
      'custom_module' => 'Cases',
    ),
    'agent_outlet_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Agent Outlet',
      'required' => false,
      'source' => 'non-db',
      'name' => 'agent_outlet_c',
      'vname' => 'LBL_AGENT_OUTLET',
      'type' => 'relate',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'Casesagent_outlet_c',
      'custom_module' => 'Cases',
    ),
    'cat_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Case Categories',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'cat_c',
      'vname' => 'LBL_CAT',
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Choose File',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'choose_file_c',
      'vname' => 'LBL_CHOOSE_FILE',
      'type' => 'multifile',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'studio' => 'visible',
      'dbType' => 'text',
      'id' => 'Caseschoose_file_c',
      'custom_module' => 'Cases',
    ),
    'save_question_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Save Question',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'save_question_c',
      'vname' => 'LBL_SAVE_QUESTION',
      'type' => 'text',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    array (
      ...
      'source' => 'custom_fields',
      'name' => 'contact_id_c',
      'vname' => 'LBL_AGENT_OUTLET_CONTACT_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Source Email',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'source_email_c',
      'vname' => 'LBL_SOURCE_EMAIL',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Casessource_email_c',
      'custom_module' => 'Cases',
    ),
    'subcategory_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Case SubCategories',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'subcategory_c',
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'subreason_list',
      'studio' => 'visible',
      'dbType' => 'enum',
      'parentenum' => 'cat_c',
      'id' => 'Casessubcategory_c',
      'custom_module' => 'Cases',
    ),
    'upload_c' => 
    array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Service of Interest',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'service_interest_c',
      'vname' => 'LBL_SERVICE_INTEREST',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'service_interest_c_list',
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Casesservice_interest_c',
      'custom_module' => 'Cases',
    ),
    'service_chanel_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Service  Channel',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'service_chanel_c',
      'vname' => 'LBL_SERVICE_CHANEL',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'service_chanel_list',
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Casesservice_chanel_c',
      'custom_module' => 'Cases',
    ),
    'email_source_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Email Source',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'email_source_c',
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'email_source_0',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Casesemail_source_c',
      'custom_module' => 'Cases',
    ),
    'category_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Old Case Categories',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'category_c',
      'vname' => 'LBL_CATEGORY',
    ...
    array (
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'service_interest_list',
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Casesproduct_type_c',
      'custom_module' => 'Cases',
    ),
    'service_persona_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Service Persona',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'service_persona_c',
      'vname' => 'LBL_SERVICE_PERSONA',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'service_persona_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Casesservice_persona_c',
      'custom_module' => 'Cases',
    ),
  ),
  'indices' => 
