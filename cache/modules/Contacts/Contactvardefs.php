 ...
 $GLOBALS["dictionary"]["Contact"]=array (
  ...
  array (
    ...
    array (
      ...
      'vname' => 'LBL_DT_TWITTER_DESCRIPTION',
      'type' => 'text',
    ),
    'dt_twitter_id' => 
    array (
      'name' => 'dt_twitter_id',
      'vname' => 'LBL_DT_TWITTER_ID',
      'type' => 'url',
      'dbType' => 'varchar',
      'link_target' => '_blank',
    ),
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Contactsslp_name_c',
      'custom_module' => 'Contacts',
    ),
    'slp_phone_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Slp Phone',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'slp_phone_c',
      'vname' => 'LBL_SLP_PHONE',
      ...
      'size' => '20',
      'dbType' => 'varchar',
      'id' => 'Contactsslp_phone_c',
      'custom_module' => 'Contacts',
    ),
    'agent_type_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Agent Type',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'agent_type_c',
      'vname' => 'LBL_AGENT_TYPE',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
