...
{/if}
<?php if (isset ( $this->_tpl_vars['vardef']['display'] ) && $this->_tpl_vars['vardef']['display'] == 'writeonly'): ?>
...
'<?php endif; ?>
       placeholder="{if !empty(<?php echo smarty_function_sugarvar(array('key' => 'value','string' => true), $this);?>
...
'<?php elseif (isset ( $this->_tpl_vars['vardef']['len'] )): ?>maxlength='<?php echo $this->_tpl_vars['vardef']['len']; ?>
'<?php endif; ?>
    <?php if (isset ( $this->_tpl_vars['vardef']['placeholder'] )): ?>placeholder="<?php echo smarty_function_sugar_translate(array('label' => $this->_tpl_vars['vardef']['placeholder']), $this);?>
"<?php endif; ?>
