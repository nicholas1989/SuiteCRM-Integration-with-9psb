...
<?php if ($this->_tpl_vars['can_export']): ?><input type="button" class="button" id="download_csv_button_old" value="<?php echo $this->_tpl_vars['MOD']['LBL_EXPORT']; ?>
"/><?php endif; ?>
<?php if ($this->_tpl_vars['can_export']): ?><input type="button" class="button" id="download_pdf_button_old" value="<?php echo $this->_tpl_vars['MOD']['LBL_DOWNLOAD_PDF']; ?>
"/><?php endif; ?>
...
<li><?php if ($this->_tpl_vars['can_export']): ?><input type="button" class="button" id="download_csv_button_old" value="<?php echo $this->_tpl_vars['MOD']['LBL_EXPORT']; ?>
"/><?php endif; ?></li>
<li><?php if ($this->_tpl_vars['can_export']): ?><input type="button" class="button" id="download_pdf_button_old" value="<?php echo $this->_tpl_vars['MOD']['LBL_DOWNLOAD_PDF']; ?>
"/><?php endif; ?></li>
...
src="<?php echo smarty_function_sugar_getimagepath(array('file' => "advanced_search.gif"), $this);?>
"></a>
...
value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_UPDATE_PARAMETERS','module' => 'AOR_Reports'), $this);?>
"/>
<script>
            <?php echo '
