<<<<<<< HEAD
<?php /* Smarty version 2.6.33, created on 2023-06-19 14:54:32
=======
...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getimage', 'modules/Emails/templates/editAccountDialogue.tpl', 113, false),)), $this); ?>
    ...
    <table border="0" cellspacing="0" cellpadding="0" class="edit view">
        <tr>
            ...
            <td style="vertical-align:bottom;"><a href="javascript:void(0);" id="prefill_gmail_defaults_link"
                                                  onclick="javascript:SUGAR.email2.accounts.fillInboundGmailDefaults();"><?php echo $this->_tpl_vars['app_strings']['LBL_EMAIL_ACCOUNTS_GMAIL_DEFAULTS']; ?>
</a>&nbsp;
            </td>
        </tr>
        <tr>
...
: <span class="required"><?php echo $this->_tpl_vars['app_strings']['LBL_REQUIRED_SYMBOL']; ?>
            ...
            <td valign="top" class="view input-button">
                ...
                <a href="javascript:void(0)" id='email_password_link'
                   ...
                   style="display: none"><?php echo $this->_tpl_vars['app_strings']['LBL_CHANGE_PASSWORD']; ?>
</a>
            </td>
        </tr>
...
: <span class="required"><?php echo $this->_tpl_vars['app_strings']['LBL_REQUIRED_SYMBOL']; ?>
            ...
            <td valign="top">
                <select name='protocol' id="protocol"
                        onchange="SUGAR.email2.accounts.setPortDefault(); SUGAR.email2.accounts.ieAccountError(SUGAR.email2.accounts.normalStyle);"><?php echo $this->_tpl_vars['PROTOCOL']; ?>
</select>
            </td>
        </tr>
        <tr>
...
: <span class="required"><?php echo $this->_tpl_vars['app_strings']['LBL_REQUIRED_SYMBOL']; ?>
            ...
            <td valign="top">
                ...
                <input type="button" id="subscribeFolderButton" name="subscribeFolderButton" class="button"
                       ...
                       value="<?php echo $this->_tpl_vars['app_strings']['LBL_EMAIL_SELECT']; ?>
"/>
            </td>
        </tr>
...
:
        ...
        <td>
            <?php echo $this->_tpl_vars['signaturesAccountSettings']; ?>
