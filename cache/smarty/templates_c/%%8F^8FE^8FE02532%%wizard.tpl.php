<?php /* Smarty version 2.6.33, created on 2023-06-20 11:29:41
         compiled from modules/Users/tpls/wizard.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'modules/Users/tpls/wizard.tpl', 68, false),array('function', 'sugar_help', 'modules/Users/tpls/wizard.tpl', 196, false),array('function', 'html_options', 'modules/Users/tpls/wizard.tpl', 197, false),)), $this); ?>
        ...
        <tr>
            <td>
                <div class="edit view">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <th align="left" scope="row" colspan="4"><h2><span><?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_PERSONALINFO']; ?>
</span></h2></th>
                        </tr>
                        <tr>
...
: <?php if ($this->_tpl_vars['REQUIRED_EMAIL_ADDRESS']): ?><span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
                            ...
                            <td width="33%"><span><input name='email1' tabindex='3' size='30' maxlength='100' value='<?php echo $this->_tpl_vars['EMAIL1']; ?>
' id='email1' /></span></td>
...
:</span></td>
                            <td width="33%" ><span><input name='address_city' tabindex='8' size='15' maxlength='100' value='<?php echo $this->_tpl_vars['ADDRESS_CITY']; ?>
'></span></td>
                            <td scope="row" nowrap="nowrap"><span><?php echo $this->_tpl_vars['MOD']['LBL_STATE']; ?>
:</span></td>
                            <td><span><input name='address_state' tabindex='9' size='15' maxlength='100' value='<?php echo $this->_tpl_vars['ADDRESS_STATE']; ?>
'></span></td>
                        </tr>
                        <tr>
                            <td scope="row" nowrap="nowrap"><span><?php echo $this->_tpl_vars['MOD']['LBL_POSTAL_CODE']; ?>
:</span></td>
                            <td><span><input name='address_postalcode' tabindex='9' size='10' maxlength='20' value='<?php echo $this->_tpl_vars['ADDRESS_POSTALCODE']; ?>
'></span></td>
                            <td scope="row" nowrap="nowrap"><span><?php echo $this->_tpl_vars['MOD']['LBL_COUNTRY']; ?>
:</span></td>
                            <td><span><input name='address_country' tabindex='10' size='10' maxlength='20' value='<?php echo $this->_tpl_vars['ADDRESS_COUNTRY']; ?>
'></span></td>
                        </tr>
                    </table>
                </div>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <th width="100%" align="left" scope="row" colspan="4">
                                <h2><span><?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_LOCALE']; ?>
</span></h2></th>
                        </tr>
                        <tr>
                            ...
                            <td scope="row">
                                ...
                                <table cellpadding=0 cellspacing=0><input id='whatnext' name='whatnext' type="hidden" value='finish' />
                                    <?php if ($this->_tpl_vars['IS_ADMIN']): ?>
                                        ...
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                        <tr><td><img src=include/images/university.png style="margin-right: 5px;"></td><td><a href="https://community.suitecrm.com" target="_blank"><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH11']; ?>
 </b></a></b><br><?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH12']; ?>
</td></tr>
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                    <?php else: ?>
                                        <tr><td><img src=include/images/university2.png style="margin-right: 5px;"></td><td><a href="https://community.suitecrm.com" target="_blank"><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH11']; ?>
 </b></a></b><br><?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH12']; ?>
</td></tr>
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                        <tr><td><img src=include/images/docs.png style="margin-right: 5px;"></td><td><a href="https://docs.suitecrm.com/user/" target="_blank"><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH14']; ?>
 </b></a></b><br><?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH15']; ?>
</td></tr>
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                        <tr><td><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="https://community.suitecrm.com/" target="_blank"><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH18']; ?>
