<<<<<<< HEAD
<?php /* Smarty version 2.6.33, created on 2023-06-19 14:54:28
=======
...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/Emails/templates/outboundDialog.tpl', 60, false),)), $this); ?>
                ...
                <td colspan="4">
                    <div id="smtp_settings">
                        <table width="100%" cellpadding="0" cellspacing="1">
                            <tr>
                                <td width="20%" scope="row" nowrap="nowrap"><span><?php echo smarty_function_sugar_translate(array('module' => 'EmailMan','label' => 'LBL_NOTIFY_FROMNAME'), $this);?>
:</span><span class="required" id="required_smtp_from_name"><?php echo $this->_tpl_vars['app_strings']['LBL_REQUIRED_SYMBOL']; ?>
</span></td>
                                <td width="30%" ><input type="text" name="smtp_from_name" id="smtp_from_name" size="30" value="" title=""></td>
                                <td width="20%" scope="row" nowrap="nowrap"><span><?php echo smarty_function_sugar_translate(array('module' => 'EmailMan','label' => 'LBL_NOTIFY_FROMADDRESS'), $this);?>
:</span><span class="required" id="required_smtp_from_addr"><?php echo $this->_tpl_vars['app_strings']['LBL_REQUIRED_SYMBOL']; ?>
</span></td>
