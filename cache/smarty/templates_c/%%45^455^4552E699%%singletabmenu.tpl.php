...
<?php $_from = $this->_tpl_vars['othertabs']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
'] = [<?php $_from = $this->_tpl_vars['tab']['tabs']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
'<?php endforeach; endif; unset($_from); ?><?php $_from = $this->_tpl_vars['otherMoreSubMenu'][$this->_tpl_vars['tab']['key']]['tabs']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['subtab']):
...
<?php $_from = $this->_tpl_vars['sugartabs']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['i'] => $this->_tpl_vars['tab']):
?>
	<li id="<?php echo $this->_tpl_vars['tab']['label']; ?>
_sp_tab" class="<?php if ($this->_tpl_vars['tab']['type'] == 'current'): ?>active<?php endif; ?>">
	...
	<tr height="20">
		<td class="subpanelSubTabBar" colspan="100" id="subpanelSubTabs">
			<table border="0" cellpadding="0" cellspacing="0" height="20" width="100%" class="subTabs">
				<tbody>
				<tr>
<?php $_from = $this->_tpl_vars['subtabs']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['tab']):
?>
...
<?php $_from = $this->_tpl_vars['moreMenu']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['tab']):
?>
...
<?php $_from = $this->_tpl_vars['otherMoreSubMenu']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['group']):
?>
<?php if (! empty ( $this->_tpl_vars['group']['tabs'] )): ?>
<div id="MoreSub<?php echo $this->_tpl_vars['group']['key']; ?>
PanelMenu" class="menu">
<?php $_from = $this->_tpl_vars['group']['tabs']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['subtab']):
?>
