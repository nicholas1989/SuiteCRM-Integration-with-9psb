<?php /* Smarty version 2.6.33, created on 2023-06-20 19:22:07
         compiled from cache/themes/SuiteP/modules/Emails/EmailsDetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Emails/EmailsDetailView.tpl', 49, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Emails/EmailsDetailView.tpl', 58, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Emails/EmailsDetailView.tpl', 125, false),array('function', 'sugar_literal', 'cache/themes/SuiteP/modules/Emails/EmailsDetailView.tpl', 380, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Emails/EmailsDetailView.tpl', 118, false),)), $this); ?>
...
<input type="button" onclick="window.location.href='index.php?module=Emails&action=DeleteFromImap&folder=INBOX.TestInbox&folder=inbound&inbound_email_record=<?php echo $this->_tpl_vars['bean']->inbound_email_record; ?>
&uid=<?php echo $this->_tpl_vars['bean']->uid; ?>
&msgno=<?php echo $this->_tpl_vars['bean']->msgNo; ?>
&record=<?php echo $this->_tpl_vars['bean']->id; ?>
&return_module=Emails&return_action=index';" value="<?php echo $this->_tpl_vars['MOD']['LBL_BUTTON_DELETE_IMAP']; ?>
"/>
...
&msgno=<?php echo $this->_tpl_vars['bean']->msgno; ?>
&record=<?php echo $this->_tpl_vars['bean']->id; ?>
&return_module=Emails&return_action=index';" value="<?php echo $this->_tpl_vars['MOD']['LBL_BUTTON_REPLY_TITLE']; ?>
"/>
...
&msgno=<?php echo $this->_tpl_vars['bean']->msgno; ?>
&record=<?php echo $this->_tpl_vars['bean']->id; ?>
&return_module=Emails&return_action=index';" value="<?php echo $this->_tpl_vars['MOD']['LBL_BUTTON_REPLY_ALL']; ?>
"/>
...
&msgno=<?php echo $this->_tpl_vars['bean']->msgno; ?>
&record=<?php echo $this->_tpl_vars['bean']->id; ?>
&return_module=Emails&return_action=index';" value="<?php echo $this->_tpl_vars['MOD']['LBL_BUTTON_FORWARD']; ?>
"/>
...
<li><input type="button" onclick="window.location.href='index.php?module=Emails&action=DeleteFromImap&folder=INBOX.TestInbox&folder=inbound&inbound_email_record=<?php echo $this->_tpl_vars['bean']->inbound_email_record; ?>
&uid=<?php echo $this->_tpl_vars['bean']->uid; ?>
&msgno=<?php echo $this->_tpl_vars['bean']->msgNo; ?>
&record=<?php echo $this->_tpl_vars['bean']->id; ?>
&return_module=Emails&return_action=index';" value="<?php echo $this->_tpl_vars['MOD']['LBL_BUTTON_DELETE_IMAP']; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_SENT_RECEIVED','module' => 'Emails'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php if (! $this->_tpl_vars['fields']['date_sent_received']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php else: ?>
<?php if (strlen ( $this->_tpl_vars['fields']['date_sent_received']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['date_sent_received']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['date_sent_received']['value']); ?>
<?php endif; ?>
<?php endif; ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['date_sent_received']['name']; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'Emails'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
