<?php /* Smarty version 2.6.33, created on 2023-07-03 08:56:15
...
<?php if (! $this->_tpl_vars['fields']['contact_type_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['contact_type_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['contact_type_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['contact_type_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['contact_type_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['contact_type_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['contact_type_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['contact_type_c']['options'][$this->_tpl_vars['fields']['contact_type_c']['value']]; ?>
...
<?php if (! $this->_tpl_vars['fields']['account_types_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['account_types_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['account_types_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['account_types_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['account_types_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['account_types_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['account_types_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['account_types_c']['options'][$this->_tpl_vars['fields']['account_types_c']['value']]; ?>
...
<?php if (! $this->_tpl_vars['fields']['gender_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
