<?php /* Smarty version 2.6.33, created on 2023-06-20 19:31:20
         compiled from cache/themes/SuiteP/modules/Contacts/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 46, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 55, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 119, false),array('function', 'sugar_phone', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 158, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 112, false),)), $this); ?>
...
'; _form.action.value='sendConfirmOptInEmail'; _form.module.value='Contacts'; _form.module_tab.value='Contacts';_form.submit();" name="send_confirm_opt_in_email" disabled="1" type="button" value="<?php echo $this->_tpl_vars['APP']['LBL_SEND_CONFIRM_OPT_IN_EMAIL']; ?>
"/>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SLP_NAME','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="varchar" field="slp_name_c" >

<?php if (! $this->_tpl_vars['fields']['slp_name_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (strlen ( $this->_tpl_vars['fields']['slp_name_c']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['slp_name_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['slp_name_c']['value']); ?>
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['slp_name_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['slp_name_c']['value']; ?>
</span>
<?php endif; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SLP_PHONE','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit phone" type="phone" field="slp_phone_c" >

<?php if (! $this->_tpl_vars['fields']['slp_phone_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['slp_phone_c']['value'] )): ?>
<?php $this->assign('phone_value', $this->_tpl_vars['fields']['slp_phone_c']['value']); ?>
<?php echo smarty_function_sugar_phone(array('value' => $this->_tpl_vars['phone_value'],'usa_format' => '0'), $this);?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOUNT_NUMBER','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php if (! $this->_tpl_vars['fields']['account_number_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['account_number_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['account_number_c']['value']; ?>
</span>
<?php endif; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATE','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LGA','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php if (! $this->_tpl_vars['fields']['lga_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['lga_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['lga_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['lga_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['lga_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['lga_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['lga_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['lga_c']['options'][$this->_tpl_vars['fields']['lga_c']['value']]; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_AGENT_TYPE','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="agent_type_c" >

<?php if (! $this->_tpl_vars['fields']['agent_type_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['agent_type_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['agent_type_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['agent_type_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['agent_type_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['agent_type_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['agent_type_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['agent_type_c']['options'][$this->_tpl_vars['fields']['agent_type_c']['value']]; ?>
