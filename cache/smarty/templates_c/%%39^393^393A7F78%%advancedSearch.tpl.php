...
" type="hidden">      
        ...
        <a href="javascript:void(0);">
			<span class="suitepicon suitepicon-action-select" align="absmiddle" border="0" alt=$mod_strings.LBL_EMAIL_SELECTOR onclick='open_popup("Users", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"advancedSearchForm","field_to_name_array":{"id":"assigned_user_id","name":"assigned_user_name"}}'; ?>
, "single", true);'></span>
        </a>
        </td>
    </tr>
...
:<br/>
        ...
        <a href="javascript:void(0);"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => 'id-ff-select.gif'), $this);?>
